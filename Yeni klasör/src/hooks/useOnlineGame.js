...
export function useOnlineGame() {
  const [status,      setStatus]      = useState('idle');   // idle | creating | waiting | joining | playing | over | disconnected
  ...
  return { status, roomCode, myPlayerNum, gs, error, isMyTurn, createRoom, joinRoom, handlePointClick, requestRestart, leave };
}
